...
import { IMAGE_TYPES } from "../types/app.types";
    ...
    >
      ...
      >
        ...
        <div className="flex w-full gap-1">
          <button
            type="button"
            className={`flex-1 border rounded-sm  dark:bg-dark_shade_1 dark:border-gray-700 ${
              fileType === IMAGE_TYPES.SVG
                ? "bg-gray-300 text-white dark:bg-gray-700"
